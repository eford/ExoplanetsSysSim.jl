...
function set_test_param(sim_param_closure::SimParam)
  ...
  add_param_fixed(sim_param_closure,"sigma_incl",0.0)   # degrees; 0 = coplanar w/ generate_kepler_target_simple; ignored by generate_planetary_system_uncorrelated_incl
