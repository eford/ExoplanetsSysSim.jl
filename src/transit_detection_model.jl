...
function calc_prob_detect_if_transit(t::KeplerTarget, snr::Real, sim_param::SimParam; num_transit::Real = 1)
  ...
  return wf*detection_efficiency_dr25_simple(snr)      # WARNING: Hardcoded simple DR25 Gamma CDF detection efficiency
end
...
function calc_ave_prob_detect_if_transit(t::KeplerTarget, snr_central::Real, sim_param::SimParam; num_transit::Real = 1)
  ...
  ave_detection_efficiency = 0.5*detection_efficiency_dr25_simple(snr_central)      # WARNING: Hardcoded simple DR25 Gamma CDF detection efficiency  
  for i in 1:(num_impact_param-1)
    ...
    ave_detection_efficiency += detection_efficiency_dr25_simple(snr)      # WARNING: Hardcoded simple DR25 Gamma CDF detection efficiency  
  end
