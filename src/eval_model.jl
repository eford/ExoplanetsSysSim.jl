## ExoplanetsSysSim/src/inference.jl
## (c) 2015 Eric B. Ford

# Demonstrates how to setup your own function to evaluate a simulated model against an observed catalog
...
function test_eval_mode_vs_sim_data()
  global sim_param_closure = setup_sim_param_demo()
  # cat_phys = generate_kepler_physical_catalog(sim_param_closure)
  # cat_obs = observe_kepler_targets_single_obs(cat_phys,sim_param_closure)
